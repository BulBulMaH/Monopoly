...
def handle_connection():
    ...
    while running:
        ...
        if game_started:
            if state['connected']:
                try:
                    data_undecoded = sock.recv(receive_size)
