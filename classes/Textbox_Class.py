...
class Textbox:
    def __init__(self, base_rect, border_size, text_padding, line_spacing, font, border_color, background_color, temp_path, ui_manager=None):
    ...
    def append_messages(self, messages):
        for message in messages:
            ...
            if message['type'] == 'text':
                ...
                audio_player = AudioPlayer(player_rect, 2, self.border_color, self.background_color, self.font, self.temp_path)
...
class SliderButton:
    def __init__(self, base_rect, border_size, border_color, background_color):
        self.element_type = 'slider button'
...
class AudioPlayer:
    def __init__(self, base_rect, border_size, border_color, background_color, font, temp_path):
        self.element_type = 'audioplayer'
    ...
    def load_audio(self, audio_path=None, audio_bytes=None):
        if audio_path:
            ...
            if extension != '.bin':
                with tempfile.NamedTemporaryFile(delete=False, suffix=extension, dir=self.temp_path) as temp_file:
                ...
                audio_number = len(os.listdir(self.temp_path))
                temp_audio_path = f'{self.temp_path}/{audio_number}.wav'
